...
class ArrayState(StateBase):
    ...
    def _state_attributes_store(self) -> Dict[str, Any]:
        ...
        #     attrs["_dtype_pickled"] = codecs.encode(dtype_pickled, "base64").decode()
        # if isinstance(self._state_data, np.recarray):
        #     attrs["_record_array"] = True
    ...
    #
    #         if "_dtype_pickled" in attributes:
    ...
    #             dtype_pickled = attributes.pop("_dtype_pickled")
    ...
    #
    #         if attributes.pop("_record_array", False):
