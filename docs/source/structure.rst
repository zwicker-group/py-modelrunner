...
.. graphviz::
   ...
   digraph Structure {
      ...
      IOBase [label=<<b>IOBase</b><br/>Basic input/output methods>, href="../packages/modelrunner.html#modelrunner.io.IOBase", target="_top"];
      ...
      Model [label=<<b>Model</b><br/>Describing simulation dynamics<br align="left"/>- Contains model parameters<br align="left"/>>, href="../packages/modelrunner.html#module-modelrunner.model", target="_top"];
      Result [label=<<b>Result</b><br/>Combination of model and a state<br align="left"/>- Contains all information for further analysis>, href="../packages/modelrunner.html#modelrunner.results.Result", target="_top"];
