#!/usr/bin/env python3 -m modelrunner.run --output data.hdf5 --method background
"""
This example shows how to submit a model to a queuing system using the magic line above.

Note that the method `background` just runs the script locally using a background process.
